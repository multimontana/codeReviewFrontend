...
import { GameFooterComponent } from '@app/modules/game/modules/singlegames/components/game-footer/game-footer.component';
...
import { PlayerRatingResourceService } from '@app/modules/app-common/services/player-rating-resource.service';
import { PlayerRatingState } from './state/player-rating.state';
...
@NgModule({
  ...
  exports: [MainMenuComponent, GameFooterComponent, AgePipe, MonthDayPipe, CountryPipePipe, BoardTypePipe, SafePipe, EmbedYoutubePipe],
  providers: [PlayerRatingResourceService],
  imports: [
    AccountStoreModule,
    SvgModule,
    RouterModule,
    NgxsModule.forFeature([PlayerRatingState]),
    CommonModule,
