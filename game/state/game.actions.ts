...
export class SetInviteCode {
  ...
  constructor(
    public opponentMode: OpponentModeEnum,
...
export class SetOpponent {
  ...
  constructor(
    public opponent: PlayerInterface,
  ) { }
}
...
export class OpponentOfferADraw {
  ...
  constructor(
    ...
    public threefoldRepetition?: boolean
  ) { }
}
...
export class SetTimeLimitNotification {
  ...
  constructor(
    public notification: TimeLimitWarningEnum,
...
export class SocketMessage {
  ...
  constructor(
    ...
    public message: GameMessageType | SocketStatus,
...
export class SetTimeControlsRequest {
  static readonly type = '[GameSate] Set time controls request';
  constructor(
    public timeControlsRequest: boolean,
  ) {}
}
...
export class SetRematchInvite {
  ...
  constructor(
    ...
    public rematchNotification: string,
  ) {
  }
}
...
export class SetOnlineRatings {
  ...
  constructor(
    public onlineRatings: OnlineRatingInterface[],
  ) {
  }
}
...
export class SetLastConnectionActive {
  static readonly type = '[GameSate] Set last connection activity flag';
  constructor(
    public flag: boolean
  ) {
  }
...
export class SetDefaultValuesAfterGame {
  static readonly type = '[GameSate] Set default values of state after game';
  constructor() {}
}

export class SetPlayerAbortedGame {
  static readonly type = '[GameSate] Set flag of player`s game abort';
  constructor(
    public flag: boolean
  ) {}
}

export class SetUidForLoadSavedOpponentRequest {
  static readonly type = '[GameSate] Set uid for load saved opponent request';
  constructor(
    public uid: string
  ) {}
}

export class SetGameSuccessfullyStarted {
  static readonly type = '[GameSate] Set game successfully started';
  constructor(
    public flag: boolean
  ) {}
}
