...
import { OpponentModeEnum } from '@app/modules/game/models';
...
export class GameService {
  ...
  @Select(GameState.opponent) gameOpponent$: Observable<PlayerInterface>;
        ...
        combineLatest([
          ...
          combineLatest([
            ...
            if (!isReplay && ready) {
              ...
              if ([OpponentModeEnum.FRIEND, OpponentModeEnum.HUMAN].includes(opp)) {
