...
export class MovesHistoryComponent implements OnChanges {
  ...
  _groupedMoves = new BehaviorSubject<[GameMoveIterface, GameMoveIterface][]>([]);
  ...
  @Output()
  select: EventEmitter<GameMoveIterface> = new EventEmitter();

  @ViewChild('wrapper', { static: true })
  wrapper: ElementRef;

  get groupedMoves(): Array<[GameMoveIterface, GameMoveIterface]> {
  ...
  onMoveSelected(move: GameMoveIterface) {
