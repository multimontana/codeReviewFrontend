...
import { GameBadgeNotification } from '@app/modules/game/models';
...
export class GameUserBadgeComponent implements OnChanges, OnDestroy, AfterViewChecked {
  ...
  @Input() messageDisplayed: GameBadgeNotification;
  ...
  messageDisplayed$: BehaviorSubject<GameBadgeNotification> = new BehaviorSubject({});
  ...
  ngOnChanges(changes: SimpleChanges) {
    ...
    if (changes['messageDisplayed']) {
      const message: GameBadgeNotification = changes['messageDisplayed'].currentValue;
