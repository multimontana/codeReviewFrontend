...
import { BehaviorSubject, Observable, Subject, combineLatest, interval, of, pipe } from 'rxjs';
...
import { debounceTime, delay, first, map, mergeMap, take, takeUntil, takeWhile, tap } from 'rxjs/operators';
...
import { GameMoveIterface, OpponentModeEnum, NewMessageInterface } from '@app/modules/game/models';
...
export class GameMenuComponent implements OnDestroy {
  ...
  @Select(GameState.opponentMode) gameOpponentMode$: Observable<OpponentModeEnum>;
