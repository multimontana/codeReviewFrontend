...
export class SetOnlineTournament {
  ...
  constructor(public tournament: OnlineTournamentInterface) {}
}
...
export class SetBoardsTournament {
  ...
  constructor(public boards: OnlineTournamentBoardInterface[]) {}
}
...
export class SetToursTournament {
  ...
  constructor(public tours: TourInterface[]) {}
}
...
export class SetStandings {
  ...
  constructor(public standings: OnlineTournamentStandingsInterface) {}
}
...
export class UpdateTournamentState {
  ...
  constructor(public changeState: OnlineTournamentStateInterface) {}
}
...
export class SetPlayerDisqualified {
  static readonly type = '[TournamentState] set player disqualified flag';
  constructor(public flag: boolean) {}
}

export class UpdateFlagResult {
  static readonly type = '[TournamnetState] update flag results';
  constructor(public flag: boolean) {}
}
