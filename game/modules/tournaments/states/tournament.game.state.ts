...
export class TournamentGameState implements NgxsOnInit {
  ...
  @Selector()
  static playerDisqualified(state: ITournamentGameState) {
    return state.playerDisqualified;
  }
  ...
  @Action(SetPlayerDisqualified)
  setPlayerDisqualified(ctx: StateContext<ITournamentGameState>, action: SetPlayerDisqualified) {
    ctx.patchState({
      playerDisqualified: action.flag
    });
  }
