...
export class PaygateImageUploadComponent implements OnChanges, ControlValueAccessor {
  ...
  public requiredImagesType  = ['image/x-png', 'image/png', 'image/gif', 'image/jpg', 'image/jpeg'];
  public requiredImageFormat = false;
  ...
  onFileSelected(file: File) {
    if (this.requiredImagesType.indexOf(file.type) !== -1) {
      if (file) {
