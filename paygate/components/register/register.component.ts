...
import { map, take, takeUntil, filter, withLatestFrom, catchError, mergeMap, tap, delay } from 'rxjs/operators';
...
export class RegisterComponent implements OnDestroy {
  ...
  form = new PaygateForm({
    email: new PaygateFormControl(this.paygatePopupService.email$.value, [
      Validators.email,
      Validators.required,
      Validators.pattern(emailRegex),
    ]),
    emails_agree: new PaygateFormControl(this.paygatePopupService.emails_agree$.value, [
